...
var _BreadcrumbItem = __webpack_require__(88);
...
var _Breadcrumb = __webpack_require__(151);
...
var FooterCommon = function (_React$Component) {
  (0, _inherits3.default)(FooterCommon, _React$Component);

  function FooterCommon() {
    (0, _classCallCheck3.default)(this, FooterCommon);
    return (0, _possibleConstructorReturn3.default)(this, (FooterCommon.__proto__ || (0, _getPrototypeOf2.default)(FooterCommon)).apply(this, arguments));
  }

  (0, _createClass3.default)(FooterCommon, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        Footer,
...
var _signOut = __webpack_require__(672);
...
var generatorAvatar = function generatorAvatar(userinfo) {
  if (userinfo.url) {
    return _react2.default.createElement(_avatar2.default, { src: userinfo.url });
  } else {
    return _react2.default.createElement(
      _avatar2.default,
...
var showInfo = function showInfo(isLogin, userinfo) {
  return isLogin ? _react2.default.createElement(
    ...
    _react2.default.createElement(
      'a',
      { href: 'javascript:;', title: '\u9000\u51FA\u767B\u5F55', onClick: handleSignOut },
      _react2.default.createElement(_icon2.default, { type: 'logout' })
    )
  ) : _react2.default.createElement(
    'div',
    { className: 'no-login' },
    _react2.default.createElement(_icon2.default, { type: 'frown-o', style: { fontSize: 16, color: '#ccc' } }),
    _react2.default.createElement(
      'span',
      null,
      '\u672A\u767B\u5F55'
...
var HeaderNav = function (_React$Component) {
  (0, _inherits3.default)(HeaderNav, _React$Component);
  ...
  function HeaderNav() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref2 = HeaderNav.__proto__ || (0, _getPrototypeOf2.default)(HeaderNav)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
...
function fetchEvent(options) {
  ...
  if (_type === 'GET') {
    ...
    for (var key in _data) {
      var _paramStr = '';
      if ((0, _typeof3.default)(_data[key]) === 'object') {
        _paramStr = key + '=' + (0, _stringify2.default)(_data[key]);
      } else {
    ...
    fetchParams = (0, _extends3.default)({}, fetchParams, {
      headers: new Headers()
    });
  } else {
    fetchParams = {
      ...
      body: (0, _stringify2.default)(_data)
    };
    fetchParams = (0, _extends3.default)({}, fetchParams, {
      method: _type,
      headers: { 'Content-Type': 'application/json' },
...
var ctx = __webpack_require__(41);
var invoke = __webpack_require__(414);
...
var _headerNav = __webpack_require__(204);

var _headerNav2 = _interopRequireDefault(_headerNav);

var _footerCommon = __webpack_require__(154);
...
var isObject = __webpack_require__(22);
var aFunction = __webpack_require__(79);
var anInstance = __webpack_require__(412);
var forOf = __webpack_require__(413);
...
var userAgent = __webpack_require__(418);
